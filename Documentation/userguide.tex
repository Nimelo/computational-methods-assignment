\section{User guide}
	...
	\fbox{\textbf{Application.exe} explicit-upwind-400-exp.conf waves.csv norms.csv optimalDeltaT.csv}
	
\section{Example configuration file} \label{app:exampleConfigurationFile}
	\lstinputlisting[caption=Example configuration file, language=C++]{../Code/Configurations/explicit-upwind-100-exp.conf}