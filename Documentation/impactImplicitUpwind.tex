\subsection{Implicit upwind}
	...
	\begin{figure}[!htbp]
		\begin{subfigure}[b]{0.5\textwidth}
			...
			\addcustomybarplot{../Code/results/impactImplicit/implicit-upwind-100-exp-CFL-0.4.conf-norms.csv}{2}{blue}{$CFL=0.4$};
		...
		\begin{subfigure}[b]{0.5\textwidth}
			...
			\addcustomybarplot{../Code/results/impactImplicit/implicit-upwind-100-sign-CFL-0.4.conf-norms.csv}{2}{blue}{$CFL=0.4$};
