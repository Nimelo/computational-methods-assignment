\subsection{Comparison of schemes}
	...
	\begin{figure}[!htbp]
		\begin{subfigure}[b]{0.5\textwidth}
			...
			\addcustomybarplot{../Code/results/comparision/implicit-upwind-400-sign.conf-norms.csv}{2}{yellow}{Implicit upwind};
		...
		\begin{subfigure}[b]{0.5\textwidth}
			...
			\addcustomybarplot{../Code/results/comparision/implicit-upwind-400-exp.conf-norms.csv}{2}{yellow}{Implicit upwind};
